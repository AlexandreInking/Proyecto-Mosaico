...
- [x] DOC-004: usuario, antiusuario y TR-01/TR-02/TR-03 en PM-01.
- [x] DOC-005: contratos de métricas F0/F1.
- [x] DOC-006: gate F0 idéntico en PM-01 y PM-14.
- [x] DOC-007: 56 requisitos con prioridad aprobada y validador bidireccional.
- [x] DOC-008: gate ejecutable por fase y MG-01.
- [x] DOC-009: límites hostiles y política de scripts/plugins.
...
- [x] ADR-001 condicionado para stack/renderer.
- [x] Contrato espacial ortogonal y coordenadas negativas.
- [x] Formato experimental de un archivo y estrategia atómica.
- [x] Máquina/fixture/protocolo de benchmark registrados sin inventar hardware.

### P3 — Slice 1: dominio ortogonal

- [x] RED: pruebas de celdas, coordenadas negativas y hash.
- [x] GREEN: `MapDocument`, `GridCoordinate` y almacenamiento disperso.
- [x] RED/GREEN: comando de pincelada y undo/redo.

**Checkpoint:** runner automático verde y build limpio.

### P4 — Slice 2: persistencia

- [x] RED: round-trip conserva ID/celdas/hash.
- [x] RED: entrada fuera de límites se rechaza sin mutar estado.
- [x] GREEN: JSON v0 experimental y guardado atómico de archivo único.

**Checkpoint:** fixture golden, pruebas verdes y archivo reabrible.

### P5 — Slice 3: host manual

- [x] Viewport con grid, picking, pan y zoom.
- [x] Pincel/borrador, undo/redo y estado visible.
- [x] Nuevo, abrir, guardar como y diagnóstico de error.
- [x] Atajos de comando y foco visible; edición espacial por teclado sigue abierta para F1.

**Checkpoint:** build Release y walkthrough reducido MG-01.

### P6 — Evidencia y entrega

- [x] Script de gate construye, prueba, empaqueta y lanza binario del mismo commit limpio.
- [x] Benchmark básico produce JSON con muestras y percentiles.
- [ ] Walkthrough humano MG-01; cero S0/S1 confirmados por operador.
